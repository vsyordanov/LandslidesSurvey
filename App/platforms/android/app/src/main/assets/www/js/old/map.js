...
function checkLocationPermissions() {
    ...
    cordova.plugins.diagnostic.getLocationAuthorizationStatus(
        ...
        err => {
            ...
            $gps.removeClass("gps-on").children("i").html("gps_off");
            createAlertDialog(i18n.t("map.permissionsCheckError"), i18n.t("dialogs.btnOk"));
...
function requestLocationPermission() {
    ...
    cordova.plugins.diagnostic.requestLocationAuthorization(
        ...
        err => {
            ...
            $gps.removeClass("gps-on").children("i").html("gps_off");
            createAlertDialog(i18n.t("map.permissionsRequestError"), i18n.t("dialogs.btnOk"));
...
function registerGPSWatcher() {
    ...
    cordova.plugins.diagnostic.registerLocationStateChangeHandler(state => {
        ...
        // Location off
            ...
            createAlertDialog(i18n.t("map.gpsOff"), i18n.t("dialogs.btnOk"));
    ...
    cordova.plugins.diagnostic.getLocationAuthorizationStatus(
        status => {
            ...
            // Permission denied and cannot be requested again
                ...
                $gps.removeClass("gps-on").children("i").html("gps_off");
                createAlertDialog(i18n.t("map.cannotRequestPermissions"), i18n.t("dialogs.btnOk"));
...
function checkGPSOn(onCallback) {
    ...
    cordova.plugins.diagnostic.isLocationEnabled(enabled => {
            ...
            $gps.removeClass("gps-on").children("i").html("gps_off");
            createAlertDialog(i18n.t("map.gpsCheckError"), i18n.t("dialogs.btnOk"));
