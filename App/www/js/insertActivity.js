...
class InsertActivity {
    ...
    post() {
        ...
        formData.append("coordinatesAccuracy", MapActivity.getInstance().currLatLngAccuracy.toString());
        formData.append("altitude", MapActivity.getInstance().currAltitude.toString());
        formData.append("altitudeAccuracy", MapActivity.getInstance().currAltitudeAccuracy.toString());
        ...
        if (!App.isCordova) {
            ...
            landslide.post(formData)
                .then((data) => {
                    ...
                    landslide.show(data.id, data.coords);
